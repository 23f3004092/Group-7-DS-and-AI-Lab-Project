...
# Mahesh
- Helped define and refine the project problem statement, scope, and overall system design by identifying key research gaps and proposing architectural improvements.
- Designed the system architecture diagram and contributed to major design decisions, including the routing strategy, trainable models, and tiered response framework.
- Explored and compiled datasets, identifying the KCC dataset as the primary knowledge source for retrieval and model training.
- Conducted the literature review by researching existing agricultural AI solutions, benchmarks, datasets, and relevant academic and industry references.
- Prepared the final Milestone 1 Markdown report by consolidating, organizing, and formatting the work of all team members, and completed the GitHub submission.
...
- Identified architectural inconsistencies and proposed improvements to strengthen the overall system design.
